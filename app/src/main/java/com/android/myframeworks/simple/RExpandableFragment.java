...
/**
 * Created by Kevin Choi on 2018/2/7.
 */

public class RExpandableFragment extends Fragment implements RExpandableListView.OnRefreshLisenter {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_rlist_expandable, null);
    }
    ...
    private void init(View view) {
        ...
        childs = new HashMap<>();
        rExpandableListView = view.findViewById(R.id.rexpandablelistview);
        ...
        adapter = new SimpleAdapter(getActivity(), groups, childs);
